// server/wealth/milestoneKeys.ts
// Authoritative list of all 33 wealth milestone keys across 5 tracks.

export const MILESTONE_KEYS = {
  // Track 1 — Foundation (7 milestones)
  T1_BUSINESS_CHECKING: 't1_business_checking',
  T1_BUSINESS_CREDIT_CARD: 't1_business_credit_card',
  T1_EOE_UMBRELLA_INSURANCE: 't1_eo_umbrella_insurance',
  T1_EMERGENCY_FUND_3MO: 't1_emergency_fund_3mo',
  T1_OPERATING_RESERVE_1MO: 't1_operating_reserve_1mo',
  T1_BENEFICIARY_DESIGNATIONS: 't1_beneficiary_designations',
  T1_BASIC_WILL: 't1_basic_will',

  // Track 2 — Business Structure (6 milestones)
  T2_LLC_FORMED: 't2_llc_formed',
  T2_OPERATING_AGREEMENT: 't2_operating_agreement',
  T2_SCORP_2553: 't2_scorp_2553',
  T2_CPA_HIRED: 't2_cpa_hired',
  T2_ACCOUNTING_SOFTWARE: 't2_accounting_software',
  T2_QUARTERLY_EST_TAX: 't2_quarterly_est_tax',

  // Track 3 — Tax Optimization (7 milestones)
  T3_SEP_IRA: 't3_sep_ira',
  T3_SCORP_SALARY_OPTIMIZED: 't3_scorp_salary_optimized',
  T3_HOME_OFFICE_DEDUCTION: 't3_home_office_deduction',
  T3_VEHICLE_STRATEGY: 't3_vehicle_strategy',
  T3_HEALTH_INS_DEDUCTION: 't3_health_ins_deduction',
  T3_WEALTH_ALLOCATION_SYSTEM: 't3_wealth_allocation_system',
  T3_ROTH_IRA: 't3_roth_ira',

  // Track 4 — Wealth Building (7 milestones)
  T4_FI_NUMBER_DEFINED: 't4_fi_number_defined',
  T4_SAVINGS_RATE_TARGET: 't4_savings_rate_target',
  T4_TERM_LIFE_INSURANCE: 't4_term_life_insurance',
  T4_FIRST_INVESTMENT_PROPERTY: 't4_first_investment_property',
  T4_INDEX_FUND_DCA: 't4_index_fund_dca',
  T4_PASSIVE_INCOME_COVERS_EXPENSES: 't4_passive_income_covers_expenses',
  T4_GIVING_STRUCTURE: 't4_giving_structure',

  // Track 5 — Legacy & FI (6 milestones)
  T5_PORTFOLIO_INCOME_50PCT: 't5_portfolio_income_50pct',
  T5_LIVING_TRUST: 't5_living_trust',
  T5_INVESTMENT_PORTFOLIO_5UNITS: 't5_investment_portfolio_5units',
  T5_FEE_ONLY_ADVISOR: 't5_fee_only_advisor',
  T5_FI_DATE_TARGETED: 't5_fi_date_targeted',
  T5_LEGACY_TRANSFER_PLAN: 't5_legacy_transfer_plan',
} as const;
...
// Milestone display metadata — label + description for UI
...
// Profile flag mapping — which milestone sets which wealthProfile boolean
export const MILESTONE_PROFILE_FLAGS: Record<string, string> = {
  't2_llc_formed': 'hasLLC',
  't2_scorp_2553': 'hasSCorp',
  't2_cpa_hired': 'hasCPA',
  't3_sep_ira': 'hasSepIra',
  't3_roth_ira': 'hasRothIra',
  't1_emergency_fund_3mo': 'hasEmergencyFund3Mo',
  't1_basic_will': 'hasBasicWill',
  't4_first_investment_property': 'hasInvestmentProperty',
};
