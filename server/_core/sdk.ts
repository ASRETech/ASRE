 ...
 * Uses JWT session cookies signed with JWT_SECRET.
 * Login/register are handled via email+password in the auth router.
 */
...
class AuthService {
  ...
  async authenticateRequest(req: Request): Promise<User> {
    ...
    // Update lastSignedIn asynchronously — don't block the request
